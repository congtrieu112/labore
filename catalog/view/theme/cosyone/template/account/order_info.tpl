...
<div id="content"><?php echo $content_top; ?>
  ...
  <table class="list">
    <thead>
      <tr>
        <td class="left contrast_font" colspan="2"><?php echo $text_order_detail; ?></td>
      </tr>
    </thead>
    <tbody>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        <td class="left"><?php echo $product['name']; ?>
          ...
          <?php } ?>
          <br /><a class="return_link" href="<?php echo $product['return']; ?>"><i class="fa fa-history"></i> <?php echo $button_return; ?></a>
          </td>
