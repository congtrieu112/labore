      ...
      <tbody id="wishlist-row<?php echo $product['product_id']; ?>">
        <tr>
          ...
          <td class="price mobile_hide"><?php if ($product['price']) { ?>
            ...
            <?php } ?></td>
          <td class="action">
          <a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button contrast"><i class="fa fa-shopping-cart"></i> <?php echo $button_cart; ?></a>
