...
<div id="content">
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <div class="content form">
      ...
      <div class="input_field_half">
        <b><?php echo $entry_birthday; ?></b>
        <input type="text" name="birthday" value="<?php echo $birthday; ?>" />
      </div>

      <!--<div class="input_field_half right"> 
        <b><?php echo $entry_skin; ?> <span class="required">*</span></b>
        <select name="skin_id">
          <option value=""><?php echo $text_select; ?></option>
          <?php foreach ($skins as $skin) { ?>
            <?php if ($skin['skin_id'] == $skin_id) { ?>
              <option value="<?php echo $skin['skin_id']; ?>" selected="selected"><?php echo $skin['name']; ?></option>
            <?php } else { ?>
              <option value="<?php echo $skin['skin_id']; ?>"><?php echo $skin['name']; ?></option>
            <?php } ?>
          <?php } ?>
        </select>
        <?php if ($error_skin) { ?>
          <span class="error"><?php echo $error_skin; ?></span>
        <?php } ?>
      </div>-->
