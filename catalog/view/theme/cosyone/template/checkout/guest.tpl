...
<div class="content form">
  ...
  <div class="input_field_half right">
    <b><?php echo $entry_birthday; ?> <span class="required">*</span></b>
    <input type="text" name="birthday" value="<?php echo $birthday; ?>" class="large-field" />
    <br />
  </div>
  <div class="input_field_half">
    <b><?php echo $entry_skin; ?></b>
    <input type="text" name="skin" value="<?php echo $skin; ?>" class="large-field" />
    <br />
  </div>
</div>
...
<div class="content form last">
  <div class="input_field_full radio" style="display: <?php echo (count($customer_groups) > 1 ? 'table-row' : 'none'); ?>;"> 
  ...
  <div class="input_field_half right" style="display:none">
  ...
  <!--<div id="company-id-display" class="input_field_half right">
  ...
  <div id="tax-id-display" class="input_field_half">
  ...
  <div class="input_field_half right" style="display:none">
    <b><?php echo $entry_postcode; ?> <span id="payment-postcode-required" class="required">*</span></b>
