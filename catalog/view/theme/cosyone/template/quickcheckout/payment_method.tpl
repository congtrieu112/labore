		  ...
		  <?php foreach ($payment_methods as $payment_method) { ?>
			<tr class="highlight">
					...
					<label for="<?php echo $payment_method['code']; ?>">
						...
						<?php } ?><?php echo $payment_method['title']; ?>
					</label>
				</td> 
			</tr>
		  <?php } ?>
		  ...
		  <select name="payment_method">
			  <?php foreach ($payment_methods as $payment_method) { ?>
				<?php if ($payment_method['code'] == $code || !$code || !$exists) { ?>
			      		<?php $code = $payment_method['code']; ?>
				  	<?php $exists = true; ?>
				  	<option value="<?php echo $payment_method['code']; ?>" selected="selected"></option>
			      	<?php } else { ?>
...
<?php if ($survey_survey) { ?>
	<span class="contrast_font input_heading"><?php if ($survey_required) { ?><span class="required">*</span> <?php } ?><?php echo $text_survey; ?></span><br />
	 <?php if ($survey_type) { ?>
	  	<select name="survey">
	...
	<?php } else { ?>
	  	<textarea name="survey" rows="1"><?php echo $survey; ?></textarea><br /><br />
	 <?php } ?>
<?php } else { ?>
