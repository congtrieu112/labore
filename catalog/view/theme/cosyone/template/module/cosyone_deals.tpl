                                ...
                                <div class="deals">
                                            <div class="deals_content">
                                                                  ...
                                                                  <div class="extended_offer">
                                                                            <?php if ($product['special']) { ?>
                                                                                        <div class="price-new">
                                                                                                    ...
                                                                                                    <span class="amount contrast_font"><?php echo $product['special']; ?></span>
                                                                                        </div>
                                                                                        <div class="price-old">
                                                                                                    <?php echo $text_old_price; ?>
                                                                                                    <span class="amount contrast_font"><?php echo $product['price']; ?></span>
                                                                                        </div>
                                                                                        <div class="price-save">
                                                                                                    <?php echo $text_you_save; ?>
                                                                                                    <span class="amount contrast_font"><?php echo $product['yousave']; ?></span> 
                                                                                        </div>
                                                                            <?php } else { ?>
                                                                                        <div class="price-regular">
                                                                                                    <span class="amount price"><?php echo $product['price']; ?></span>
                                                                                        </div>
                                                                            <?php } ?>
                                                                 </div>        
                                                                 <?php if ($product['special_date_end'] > 0) { ?>
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <?php } ?> <!-- if price ends -->
                                                        <div class="cart">
                                                                <button type="submit" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button contrast"><i class="fa fa-shopping-cart"></i> <?php echo $button_cart; ?></button>
