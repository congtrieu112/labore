<?php if($this->config->get('cosyone_header_login') == 'enabled'){ ?>
<?php if (!$logged) { ?>
	<div class="login_drop_heading contrast_font">
  		<a  class="log_link" href="<?php echo $login_link; ?>"><i class="fa fa-user"></i> <?php echo $text_login; ?>&nbsp;<i class="fa fa-angle-down"></i></a>
