...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			if ((float)$product_info['special']) {
				...
				$this->data['sales_percantage_main'] = round((($product_info['price'] - $product_info['special']) / $product_info['price'] * 100));
			} else {
			...
			if ((float)$product_info['special']) {
    				$special_info = $this->model_catalog_product->getSpecialPriceEnd($product_id);
        				$this->data['special_date_end'] = strtotime($special_info['date_end']) - time();

				$this->data['yousave'] = $this->currency->format(($this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')))-($this->tax->calculate($product_info['special'], $product_info['tax_class_id'], $this->config->get('config_tax'))));
			
    			} else {
        				$this->data['special_date_end'] = false;
    			}
			...
			$this->data['data_qty'] = $product_info['quantity'];
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/product.tpl')) {
				...
				$this->template = 'cosyone/template/product/product.tpl';
			}
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/error/not_found.tpl')) {
				...
				$this->template = 'cosyone/template/error/not_found.tpl';
			}
	...
	public function review() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/review.tpl')) {
			...
			$this->template = 'cosyone/template/product/review.tpl';
		}
