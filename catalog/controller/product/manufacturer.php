...
class ControllerProductManufacturer extends Controller {  
	public function index() { 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_list.tpl')) {
			...
			$this->template = 'cosyone/template/product/manufacturer_list.tpl';
		}			
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			foreach ($results as $result) {
				...
				$this->data['text_category_expire'] = $this->language->get('text_category_expire');
				...
				$this->data['products'][] = array(
					...
					// Cosyone custom code starts	
			 		...
			 		'special_date_end' => $special_date_end,
			  		...
			  		'thumb_hover'  => $this->model_tool_image->resize($images, $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height')),$this->config->get('config_image_product_width'),
			  		// Cosyone custom code ends
					'tax'         => $tax,
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_info.tpl')) {
				...
				$this->template = 'cosyone/template/product/manufacturer_info.tpl';
			}
