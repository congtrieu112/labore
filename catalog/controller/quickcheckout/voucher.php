...
class ControllerQuickCheckoutVoucher extends Controller {
	public function index() {
		...
		$this->data['entry_reward'] = sprintf($this->language->get('entry_reward'), $points_total, $this->customer->getRewardPoints());
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/quickcheckout/voucher.tpl')) {
			...
			$this->template = 'cosyone/template/quickcheckout/voucher.tpl';
		}
