...
class ControllerQuickCheckoutConfirm extends Controller { 
	public function index() {
		...
		if (!$redirect) {
			...
			$this->data['back'] = $this->url->link('quickcheckout/checkout');
			...
			if ($this->session->data['comment'] != '') {
				$this->session->data['comment'] = "@@Comment: " . $this->session->data['comment'];
			}
			
			if ($this->session->data['survey'] != '') {
				$this->session->data['comment'] = "@@Survey: " . $this->session->data['survey'] . "\n" . $this->session->data['comment'];
			}
			
			if ($this->session->data['delivery_time'] != '') {
				$this->session->data['comment'] = "@@Delivery Time: " . $this->session->data['delivery_time'] . "\n" . $this->session->data['comment'];
			}
			
			if ($this->session->data['delivery_date'] != '') {
				$this->session->data['comment'] = "@@Delivery Date: " . $this->session->data['delivery_date'] . "\n" . $this->session->data['comment'];
			}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/quickcheckout/confirm.tpl')) {
			...
			$this->template = 'cosyone/template/quickcheckout/confirm.tpl';
		}
