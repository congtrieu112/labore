...
class ControllerAccountAddress extends Controller {
	...
	protected function getList() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/address_list.tpl')) {
			...
			$this->template = 'cosyone/template/account/address_list.tpl';
		}
	...
	protected function getForm() {
		...
		$this->data['entry_cosyone'] = $this->language->get('entry_cosyone');
		...
		if (isset($this->request->post['cosyone'])) {
			$this->data['cosyone'] = $this->request->post['cosyone'];
		} elseif (isset($this->request->get['address_id'])) {
			$this->data['cosyone'] = $this->customer->getAddressId() == $this->request->get['address_id'];
		} else {
			$this->data['cosyone'] = false;
		}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/address_form.tpl')) {
			...
			$this->template = 'cosyone/template/account/address_form.tpl';
		}
	...
	protected function validateDelete() {
		...
		if ($this->customer->getAddressId() == $this->request->get['address_id']) {
			$this->error['warning'] = $this->language->get('error_cosyone');
		}
