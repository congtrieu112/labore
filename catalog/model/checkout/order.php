	...
	public function update($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info && $order_info['order_status_id']) {
         ...
         public function get_district(){
               $query = $this->db->query("SELECT ".DB_PREFIX."district.`name`,".DB_PREFIX."district.type,".DB_PREFIX."district.districtid,".DB_PREFIX."district.location,".DB_PREFIX."district.provinceid FROM ".DB_PREFIX."district WHERE ".DB_PREFIX."district.provinceid = 79");
              return $query;
        }
}
?>