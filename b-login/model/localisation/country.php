...
//		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "district WHERE country_id = '" . (int)$country_id . "'");
                $query = $this->db->query("SELECT DISTINCT * FROM ".DB_PREFIX."district WHERE ".DB_PREFIX."district.provinceid = 79");
