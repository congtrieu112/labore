...
class ControllerExtensionModule extends Controller {
	public function index() {
		if ($this->config->get('qa_installed')) { define("PQA_STATUS", $this->config->get('qa_status')); }

		
		$this->document->addStyle('//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.min.css');
