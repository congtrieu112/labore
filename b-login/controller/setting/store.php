...
class ControllerSettingStore extends Controller {
	...
	public function getForm() { 
		...
		if (isset($this->request->post['config_facebook'])) {
			...
			$this->data['config_facebook'] = $store_info['config_facebook'];		
		} else {
			$this->data['config_facebook'] = '';
		}

		if (isset($this->request->post['config_twitter'])) {
			$this->data['config_twitter'] = $this->request->post['config_twitter'];
		} elseif (isset($store_info['config_twitter'])) {
			$this->data['config_twitter'] = $store_info['config_twitter'];		
		} else {
			$this->data['config_twitter'] = '';
		}

		if (isset($this->request->post['config_google'])) {
			$this->data['config_google'] = $this->request->post['config_twitter'];
		} elseif (isset($store_info['config_google'])) {
			$this->data['config_google'] = $store_info['config_google'];		
		} else {
			$this->data['config_google'] = '';
		}

		if (isset($this->request->post['config_linkedin'])) {
			$this->data['config_linkedin'] = $this->request->post['config_linkedin'];
		} elseif (isset($store_info['config_linkedin'])) {
			$this->data['config_linkedin'] = $store_info['config_linkedin'];		
		} else {
			$this->data['config_linkedin'] = '';
		}
