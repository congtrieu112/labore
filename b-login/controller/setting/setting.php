...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_qa'] = $this->language->get('entry_qa');
		...
		if (isset($this->request->post['config_linkedin'])) {
			...
			$this->data['config_linkedin'] = $this->config->get('config_linkedin');
		}
		...
		if (isset($this->request->post['config_qa_status'])) {
			$this->data['config_qa_status'] = $this->request->post['config_qa_status'];
		} else {
			$this->data['config_qa_status'] = $this->config->get('config_qa_status');
		}
