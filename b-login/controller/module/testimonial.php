...
class ControllerModuleTestimonial extends Controller {
	...
	public function index() {   
		...
		$this->data['testimonial_version'] = "1.5.3 (OpenCart 1.5.x)";
		...
		$this->data['entry_show_links'] = $this->language->get('entry_show_links');
		$this->data['entry_full_width'] = $this->language->get('entry_full_width');
