    ...
    <div class="content">
      <div class="overview">
        ...
        <div class="dashboard-content">
          <table>
            ...
            <?php if(isset($total_qa)) { ?>
                <tr>
                  <td><a href="<?php echo $qa; ?>"><?php echo $text_total_qa; ?></a></td>
                  <td align="right"><?php echo $total_qa; ?></td>
                </tr>
                <tr>
                  <td><a href="<?php echo $qa; ?>"><?php echo $text_total_qa_answer; ?></a></td>
                  <td align="right"><?php echo $total_qa_answer; ?></td>
                </tr>
            <?php } ?>
            <tr>
      ...
      <div class="statistic">
        ...
        <div class="dashboard-content">
          ...
          <?php } else { ?>
          <div id="report" style="width: 390px; height: 200px; margin: auto;"></div>
          <?php } ?>
        </div>
      </div>
      <div class="latest">
