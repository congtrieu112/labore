            ...
            <div id="language<?php echo $language['language_id']; ?>">
              <table class="form">
                <tr>
                  ...
                  <td><input type="text" name="news_category_description[<?php echo $language['language_id']; ?>][name]" id="title" onkeyup="ChangeToSlug();" size="100" value="<?php echo isset($news_category_description[$language['language_id']]) ? $news_category_description[$language['language_id']]['name'] : ''; ?>" />
          ...
          <table class="list">
            ...
            <tbody>
              <tr>
                ...
                <td class="left">
                  <select name="cat_layout[0][layout_id]">
                    <option value=""></option>
            ...
            <?php foreach ($stores as $store) { ?>
              <tbody>
                <tr>
                  ...
                  <td class="left">
                    <select name="cat_layout[<?php echo $store['store_id']; ?>][layout_id]">
                      <option value=""></option>
                      <?php foreach ($layouts as $layout) { ?>
