            ...
            <div id="language<?php echo $language['language_id']; ?>">
              <table class="form">
                <tr>
                  ...
                  <td>
                    <input type="text" name="product_description[<?php echo $language['language_id']; ?>][name]" id="title" onkeyup="ChangeToSlug();" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="keyword" id="slug" value="<?php echo $keyword; ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><textarea name="sku" cols="40" rows="5"><?php echo $sku; ?></textarea></td>
            </tr>
            <tr>
        ...
        <div id="tab-links">
          <table class="form">
            <tr>
              ...
              <td>
                <div class="scrollbox" style="width: 600px; height: 400px;">
                  <?php $class = 'odd'; ?>
                ...
                <a onclick="$(this).parent().find(':checkbox').attr('checked', true);"><b><?php echo 'Select all'; ?></b></a> / <a onclick="$(this).parent().find(':checkbox').attr('checked', false);"><b><?php echo 'Clear'; ?></b></a>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <table>
                  <tr>
                    ...
                    <!--<?php
                      echo "<pre>".print_r($product_category,true)."</pre>";
                    ?>-->
                  </tr>
                  <tr>
                    ...
                    <?php foreach ($product_attributes as $product_attribute) { ?>
                        <tbody id="attribute-row<?php echo $attribute_row; ?>">
                              <tr>
                                    ...
                                    <td class="left">
                                          <a onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a>
                                    </td>
                              </tr>
                        </tbody>
                        <?php $attribute_row++; ?>
        ...
        <div id="tab-product_tab">
          <div id="vtab-product_tab" class="vtabs">
            ...
            <span id="product_tab-add">
              ...
              &nbsp;<img src="view/image/add.png" alt="<?php echo $button_add_product_tab; ?>" title="<?php echo $button_add_product_tab; ?>" />
            </span>
          </div>
          <?php $product_tab_row = 0; ?>
          <?php foreach ($product_tabs as $product_tab) { ?>
...
<script type="text/javascript">
  function ChangeToSlug()
  {
    ...
    document.getElementById('slug').value = slug+'.html';
  }
</script>
<?php echo $footer; ?>