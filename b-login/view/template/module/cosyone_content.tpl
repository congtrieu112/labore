...
<td><input type="text" name="cosyone_content_module[<?php echo $module_row; ?>][module_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['module_title'][$language['language_id']]) ? $module['module_title'][$language['language_id']] : ''; ?>" size="40" /></td>
</tr>
<?php } ?>
          
          <tr>
          <td>Template<span class="help">"Recommendation: Use Call to action (full width) with position = Content bottom or Footer</span></td>
            <td>
          <select name="cosyone_content_module[<?php echo $module_row; ?>][template]">
                    <?php if ($module['template'] != '') {
              					$chosen_type = 'selected="selected"';
              					?>
                    <option value="plain" <?php if($module['template']=='plain'){echo $chosen_type;} ?>>Plain (no styling)</option>
                    <option value="info1" <?php if($module['template']=='info1'){echo $chosen_type;} ?>>Info blocks 1</option>
                    <option value="info2" <?php if($module['template']=='info2'){echo $chosen_type;} ?>>Info blocks 2</option>
                    <option value="action1" <?php if($module['template']=='action1'){echo $chosen_type;} ?>>Call to action (boxed)</option>
                    <option value="action2" <?php if($module['template']=='action2'){echo $chosen_type;} ?>>Call to action (full width)</option>
                    <?php } else { ?>
                    <option value="plain" selected="selected">Plain (no styling)</option>
                    <option value="info1">Info blocks 1</option>
                    <option value="info2">Info blocks 2</option>
                    <option value="action1">Call to action (boxed)</option>
                    <option value="action2">Call to action (full width)</option>
                    <?php } ?>
                  </select></td>
          </tr>
          ...
          <td>Columns</td>
            <td>
          <select name="cosyone_content_module[<?php echo $module_row; ?>][columns]">
                    <?php if ($module['columns'] != '') {
              					$chosen_type = 'selected="selected"';
              					?>
                    <option value="column-1" <?php if($module['columns']=='column-1'){echo $chosen_type;} ?>>1 column</option>
                    <option value="column-2" <?php if($module['columns']=='column-2'){echo $chosen_type;} ?>>2 columns</option>
                    <option value="column-3" <?php if($module['columns']=='column-3'){echo $chosen_type;} ?>>3 columns</option>
                    <option value="column-4" <?php if($module['columns']=='column-4'){echo $chosen_type;} ?>>4 columns</option>
                    <?php } else { ?>
                    <option value="column-1" selected="selected">1 column</option>
                    <option value="column-2">2 columns</option>
                    <option value="column-3">3 columns</option>
                    <option value="column-4">4 columns</option>
                    <?php } ?>
                  </select></td>
          </tr>
          ...
          <tr>
            ...
            <td><select name="cosyone_content_module[<?php echo $module_row; ?>][layout_id]">
          ...
          <tr>
            ...
            <td><select name="cosyone_content_module[<?php echo $module_row; ?>][position]">
          ...
          <tr>
            ...
            <td><select name="cosyone_content_module[<?php echo $module_row; ?>][status]">
          ...
          <tr>
            ...
            <td><input type="text" name="cosyone_content_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
          </tr>
        </table>
...
function addModule() {	
    ...
    html += '    <td><input type="text" name="cosyone_content_module[' + module_row + '][module_title][<?php echo $language['language_id']; ?>]" size="40" /></td>';
    html += '    </tr>';
    <?php } ?>

	html += '    <tr>';
	html += '      <td>Template<span class="help">Recommendation: Use Call to action (full width) with position = Content bottom or Footer</span></td>';
	html += '      <td><select name="cosyone_content_module[' + module_row + '][template]">';
	html += '		<option value="plain">Plain (no styling)</option>';
    html += '       <option value="info1">Info blocks 1</option>';
    html += '       <option value="info2">Info blocks 2</option>';
    html += '       <option value="action1">Call to action (boxed)</option>';
    html += '       <option value="action2">Call to action (full width)</option>';
	html += '      </select></td>';
	html += '    </tr>';
	
	html += '    <tr>';
	html += '      <td>Columns</td>';
	html += '      <td><select name="cosyone_content_module[' + module_row + '][columns]">';
	html += '		<option value="column-1">1 column</option>';
    html += '       <option value="column-2">2 columns</option>';
    html += '       <option value="column-3">3 columns</option>';
    html += '       <option value="column-4">4 columns</option>';
	html += '      </select></td>';
	html += '    </tr>';				
					
	html += '    <tr>';
	html += '      <td><?php echo $entry_layout; ?></td>';
	html += '      <td><select name="cosyone_content_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="cosyone_content_module[' + module_row + '][position]">';
	...
	html += '      <td><select name="cosyone_content_module[' + module_row + '][status]">';
	...
	html += '      <td><input type="text" name="cosyone_content_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
...
function addSection( module_number) {
	...
	html += '          	<?php echo $text_title; ?><input name="cosyone_content_module[' + module_number + '][sections][' + section_row + '][title][<?php echo $language['language_id']; ?>]" id="title-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" /><br /><br />';
	html += '          	<textarea name="cosyone_content_module[' + module_number + '][sections][' + section_row + '][description][<?php echo $language['language_id']; ?>]" id="description-' + module_number + '-' + section_row + '-<?php echo $language['language_id']; ?>"></textarea>';
	html += '    	</div>';
					<?php } ?>
	html += '    </td>';
