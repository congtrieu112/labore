...
<style>
	.contrast_font, .contrast_font_heading, .contrast_font_heading2, .contrast_font_sub_heading { font-family: 'Roboto Slab', serif;}
	body, .main_font { font-family: 'Roboto', serif;}
</style>
<?php } ?>
<!-- Custom fonts -->
<?php 
...
<body class="body-dark">
 		<?php //  echo '<pre>'.print_r( $slider->layers,1 ); die; ?>
