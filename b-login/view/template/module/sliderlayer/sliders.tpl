					            ...
					            <tr>
					              ...
					              <td class="left">
					              	<div class="scrollbox">
										...
										<?php $store_id = isset($module['store_id'])?$module['store_id']:array("0"); ?>
										<div class="<?php echo $class; ?>">
											<?php if (in_array($store['store_id'], $store_id)) { ?>
											<input type="checkbox" name="pavsliderlayer_module[<?php echo $module_row; ?>][store_id][]" value="<?php echo $store['store_id']; ?>" checked="checked" />
											<?php echo $store['name']; ?>
											<?php } else { ?>
											<input type="checkbox" name="pavsliderlayer_module[<?php echo $module_row; ?>][store_id][]" value="<?php echo $store['store_id']; ?>" />
											<?php echo $store['name']; ?>
											<?php } ?>
										</div>
										<?php } ?>
					              ...
					              <td class="left"><select name="pavsliderlayer_module[<?php echo $module_row; ?>][position]">
					                  <?php if ($module['position'] == 'home_top_fullwidth') { ?>
					                  <option value="home_top_fullwidth" selected="selected">Home top full width</option>
					                  <?php } else { ?>
					                  <option value="home_top_fullwidth">Home top full width</option>
					                  <?php } ?>
...
function addModule() {	
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="pavsliderlayer_module[' + module_row + '][banner_id]">';
	<?php foreach ($slidergroups as $sg) { ?>
	...
	html += '					<input <?php echo $checked; ?> type="checkbox" name="pavsliderlayer_module[<?php echo $module_row; ?>][store_id][]" value="<?php echo $store["store_id"]; ?>" />';
