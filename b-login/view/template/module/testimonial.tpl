...
<br>
        ...
        <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <table class="form">
            ...
            <tr>
                <td><?php echo $entry_carousel; ?></td>
	          <?php if (isset($module['testimonial_carousel'])) { ?>
      	    	   <td><input type="checkbox" name="testimonial_module[<?php echo $module_row; ?>][testimonial_carousel]" value="0" checked="checked"  /></td>
		    <?php } else { ?>
      	    	   <td><input type="checkbox" name="testimonial_module[<?php echo $module_row; ?>][testimonial_carousel]" value="0"   /></td>
		    <?php } ?>
            </tr>
            <tr>
            
            <tr>
                <td><?php echo $entry_show_links; ?></td>
	          <?php if (isset($module['testimonial_show_links'])) { ?>
      	    	   <td><input type="checkbox" name="testimonial_module[<?php echo $module_row; ?>][testimonial_show_links]" value="0" checked="checked"  /></td>
		    <?php } else { ?>
      	    	   <td><input type="checkbox" name="testimonial_module[<?php echo $module_row; ?>][testimonial_show_links]" value="0"   /></td>
		    <?php } ?>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><select name="testimonial_module[<?php echo $module_row; ?>][columns]">
                  <?php if ($module['columns'] == 'grid4') { ?>
                  <option value="grid4" selected="selected">4</option>
                  <?php } else { ?>
                  <option value="grid4">4</option>
                  <?php } ?>
                  
                  <?php if ($module['columns'] == 'grid3') { ?>
                  <option value="grid3" selected="selected">3</option>
                  <?php } else { ?>
                  <option value="grid3">3</option>
                  <?php } ?>
                  
                  <?php if ($module['columns'] == 'grid2') { ?>
                  <option value="grid2" selected="selected">2</option>
                  <?php } else { ?>
                  <option value="grid2">2</option>
                  <?php } ?>
                  
                  <?php if ($module['columns'] == 'grid1') { ?>
                  <option value="grid1" selected="selected">1</option>
                  <?php } else { ?>
            ...
            <tr>
                <td><?php echo $entry_full_width; ?></td>
	          <?php if (isset($module['testimonial_full_width'])) { ?>
      	    	   <td><input type="checkbox" name="testimonial_module[<?php echo $module_row; ?>][testimonial_full_width]" value="0" checked="checked"  /></td>
		    <?php } else { ?>
      	    	   <td><input type="checkbox" name="testimonial_module[<?php echo $module_row; ?>][testimonial_full_width]" value="0"   /></td>
		    <?php } ?>
            </tr>
            <tr>
		...
		<br>
		<div style="text-align:center; color:#555555;">Customer Testimonials v<?php echo $testimonial_version; ?></div>
...
function addModule() {	
	...
	html += '            <td><input type="checkbox" name="testimonial_module[' + module_row + '][testimonial_carousel]" value="0"  /></td>';
	html += '  </tr>';
	
	html += '  <tr>';
	html += '            <td><?php echo $entry_show_links; ?></td>';
	html += '            <td><input type="checkbox" name="testimonial_module[' + module_row + '][testimonial_show_links]" value="0"  /></td>';
	html += '  </tr>';
	...
	html += '      <td><select name="testimonial_module[' + module_row + '][columns]">';
	html += '      <option value="grid4">4</option>';
	html += '      <option value="grid3">3</option>';
	html += '      <option value="grid2">2</option>';
	html += '      <option value="grid1">1</option>';
	html += '      </select></td>';
	html += '    </tr>';
	...
	html += '        <option value="footer_modules">Footer modules</option>';
	html += '      </select></td>';
	html += '    </tr>';
	
	html += '  <tr>';
	html += '            <td><?php echo $entry_full_width; ?></td>';
	html += '            <td><input type="checkbox" name="testimonial_module[' + module_row + '][testimonial_full_width]" value="0"  /></td>';
	html += '  </tr>';
