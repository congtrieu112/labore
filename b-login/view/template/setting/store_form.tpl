        ...
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="config_facebook" value="<?php echo $config_facebook; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_twitter; ?></td>
              <td><input type="text" name="config_twitter" value="<?php echo $config_twitter; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_google; ?></td>
              <td><input type="text" name="config_google" value="<?php echo $config_google; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_linkedin; ?></td>
              <td><input type="text" name="config_linkedin" value="<?php echo $config_linkedin; ?>" /></td>
            </tr>
          </table>
        </div>
        <div id="tab-store">
