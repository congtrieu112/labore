          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'gz.name') { ?>
                ...
                <?php } ?></td>  
              <td class="left"><?php if ($sort == 'gd.name') { ?>
                <a href="<?php echo $sort_geo_district; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_geo_district; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_geo_district; ?>"><?php echo $column_geo_district; ?></a>
                <?php } ?></td>                        
