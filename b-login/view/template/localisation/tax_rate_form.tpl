    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            <td><?php echo $entry_geo_district; ?></td>
            <td><select name="geo_district_id">
                <?php foreach ($geo_districts as $geo_district) { ?>
                <?php  if ($district_zone['geo_district_id'] == $district_zone_id) { ?>
                <option value="<?php echo $geo_district['geo_district_id']; ?>" selected="selected"><?php echo $geo_district['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $geo_district['geo_district_id']; ?>"><?php echo $geo_zone['name']; ?></option>
                <?php } ?>
                <?php } ?>
              </select></td>
          </tr>
