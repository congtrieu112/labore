...
// Entry
$_['entry_url']                 = 'URL Gian hàng:<br /><span class="help">Bao gồm URL đầy đủ cửa hàng của bạn. Hãy chắc chắn đã thêm vào \'/\' ở cuối. Ví dụ: http://www.yourdomain.com/path/<br /><br />Không sử dụng thư mục để tạo ra một cửa hàng mới. Bạn nên luôn luôn điểm khác miền phụ tên miền để lưu trữ của bạn.</span>';
...
$_['entry_catalog_limit'] 	    = 'Mặc định Tìm Mỗi trang(Danh mục):<br /><span class="help">Xác định như thế nào các cửa hàng nhiều sẽ được hiển thị trên mỗi trang (sản phẩm, chủng loại, vv)</span>';
...
$_['entry_use_ssl']             = 'Use SSL:<br /><span class="help">Để sử dụng SSL kiểm tra máy chủ của bạn nếu một chứng chỉ SSL được cài đặt.</span>';
...
$_['error_default']             = 'Cảnh báo: Bạn không thể xoá lưu trữ mặc định của bạn!';
$_['error_store']               = 'Cảnh báo: Cửa hàng này không thể bị xóa vì nó đang dùng cho %s đơn hàng!';
?>